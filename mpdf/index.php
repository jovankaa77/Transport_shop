...
$query = $conn->query("SELECT * FROM pengajuan a, perusahaan b, user c WHERE a.id_perusahaan=b.id_perusahaan AND a.id_user=c.id_user AND a.id_user = '$id' ");
...
// foreach ($name as $n) {
 ...
 <div style="  position:absolute;top:410px;left:300px;width:75% " ><h2 align="center" style="font-family:Times New Roman, Times, serif;color: #414143;font-weight:bold;"> ' . $perusahaan . ' </h2></div>
